  ...
  <section class="w-full rounded-[12px] border border-[#D9D9D9] p-[16px]">
    ...
    <div class="mt-[8px] flex flex-col gap-[8px] md:flex-row md:items-center">
      <input
        v-model="keyword"
        type="text"
        class="h-[44px] w-full rounded-[8px] border border-[#D9D9D9] px-[12px] outline-none"
        placeholder="กรอกคำที่ต้องการค้นหาหรือเลือกไฟล์รูป"
      />

      <button
        type="button"
        class="h-[44px] w-full rounded-[8px] bg-[#A50F19] px-[16px] text-white md:w-[140px]"
        @click="onQuickSearch"
      >
        ค้นหาด้วยคำ
      </button>
    ...
    <div class="mt-[12px]">
      <button
        type="button"
        class="inline-flex h-[40px] items-center gap-[8px] rounded-[8px] border border-[#FE572F] bg-[#FFEFEB] px-[12px] text-[#FE572F]"
