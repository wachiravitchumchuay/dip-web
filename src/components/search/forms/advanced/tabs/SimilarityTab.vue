<template>
  <div class="w-full">
    ...
    <div class="flex gap-[8px]">
      <button
        type="button"
        class="h-[40px] rounded-[8px] border border-[#D9D9D9] px-[12px] text-[16px]"
        :class="
          mode === 'keyword'
    ...
    <div class="mt-[12px] rounded-[12px] bg-white p-[12px]">
      <!-- เพิ่มเงื่อนไข -->
      <div class="flex items-center gap-[8px] text-[18px]">
        <div class="font-semibold">เงื่อนไขคำ</div>
        <span
          class="flex h-[16px] w-[16px] items-center justify-center rounded-full bg-[#B21F29] text-[12px] text-white"
          >!</span
        >
      </div>
      ...
      <div class="mt-[12px] grid grid-cols-12 gap-[12px]">
        <div class="col-span-12 md:col-span-5">
          <div class="mb-[6px] flex items-center gap-[8px] text-[16px]">
          ...
          <div class="relative">
            <select
              ...
              class="h-[44px] w-full appearance-none rounded-[10px] border border-[#D9D9D9] bg-white px-[12px] pr-[40px] text-[16px]"
            >
        ...
        <div class="col-span-12 md:col-span-5">
          ...
          <input
            ...
            type="text"
            class="h-[44px] w-full rounded-[10px] border border-[#D9D9D9] bg-white px-[12px] text-[16px]"
      ...
      <!-- เงื่อนไขเสียง -->
      <div class="mt-[18px] flex items-center gap-[8px] text-[18px]">
      ...
      <div class="mt-[12px] grid grid-cols-12 gap-[12px]">
        <div class="col-span-12 md:col-span-6">
          <div class="mb-[6px] text-[16px]">เงื่อนไขเสียง</div>
          <div class="relative">
            <select
        ...
        <div class="col-span-12 md:col-span-6">
          <div class="mb-[6px] text-[16px]">เสียงคำพ้องแต่ละพยางค์</div>
          <input
            v-model="soundValue"
            type="text"
            class="h-[44px] w-full rounded-[10px] border border-[#D9D9D9] bg-white px-[12px] text-[16px]"
      ...
      <div class="mt-[12px] grid grid-cols-12 gap-[12px]">
        <div class="col-span-12 md:col-span-6">
          <div class="mb-[6px] text-[16px]">อักษรแรก</div>
          <div class="relative">
            <select
        ...
        <div class="col-span-12 md:col-span-6">
          <div class="mb-[6px] text-[16px]">เสียงท้าย</div>
          <div class="relative">
            <select
        ...
        <div class="col-span-12 md:col-span-6">
          <div class="mb-[6px] text-[16px]">เสียงท้ายอื่น</div>
          <div class="relative">
            <select
              v-model="soundMatch"
              class="h-[44px] w-full appearance-none rounded-[10px] border border-[#D9D9D9] bg-white px-[12px] pr-[40px] text-[16px]"
        ...
        <div class="col-span-12 md:col-span-6">
          ...
          <div class="grid grid-cols-12 gap-[8px]">
            ...
            >
              ...
              <span class="text-[16px]">เสียงคน</span>
            </label>

            <div class="col-span-3 relative">
              <select
                v-model="typeTextJoin"
                class="h-[44px] w-full appearance-none rounded-[10px] border border-[#D9D9D9] bg-white px-[10px] pr-[34px] text-[16px]"
              >
        ...
        <div class="col-span-12 md:col-span-6">
          ...
          <div class="grid grid-cols-12 gap-[8px]">
            ...
            >
              ...
              <span class="text-[16px]">เสียงสัตว์</span>
            </label>
        ...
        <div class="col-span-12 md:col-span-6">
          ...
          <div class="grid grid-cols-12 gap-[8px]">
            ...
            >
              ...
              <span class="text-[16px]">เสียงดนตรี / ประกอบดนตรี</span>
            </label>
        ...
        <div class="col-span-12 md:col-span-6">
          ...
          <div class="grid grid-cols-12 gap-[8px]">
            ...
            >
              ...
              <span class="text-[16px]">เสียงอื่นๆ</span>
            </label>
      ...
      <div class="mt-[12px]">
        <button
          type="button"
          class="h-[44px] rounded-[10px] border border-[#D9D9D9] bg-white px-[14px] text-[16px]"
        >
          + เพิ่มกลุ่มเงื่อนไข
        </button>
      </div>
      ...
      <div class="mt-[18px] flex items-center justify-between">
        ...
        <button
          type="button"
          class="h-[44px] rounded-[10px] bg-[#1E8E6E] px-[18px] text-[16px] text-white"
          @click="onSubmit()"
        >
          ค้นหาข้อมูล
        </button>
