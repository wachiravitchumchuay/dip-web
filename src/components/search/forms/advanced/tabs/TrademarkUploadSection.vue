<template>
  <div class="w-full">
    <div class="bg-white">
      <div
        class="flex items-start gap-3 rounded-lg border border-[#FFC5C5] bg-[#FFECEB] px-[16px] py-[12px] text-[#D12E2E] mb-[24px]"
      >
        <svg
          width="20"
          height="20"
      ...
      >
        ...
        <div class="flex flex-col items-center justify-center text-center">
          <div class="mb-4 relative">
            <div
              class="flex h-[64px] w-[64px] items-center justify-center rounded-full bg-[#FFECEB]"
            >
              <svg
                width="32"
                height="32"
          ...
          <div class="mt-[12px] text-lg text-[#333] font-bold">
            ...
            <button
              type="button"
              class="text-[#B21F29] underline decoration-[#B21F29] underline-offset-2 hover:text-[#D14022]"
            >
              เลือกไฟล์อัปโหลด
            </button>
          </div>
          ...
          <div
            v-if="fileName"
            class="mt-[16px] inline-flex items-center gap-2 rounded-full bg-[#E8F5E9] px-4 py-1 text-[#1B8A6B] font-medium border border-[#1B8A6B]/20"
          >
            <svg
              width="16"
              height="16"
    ...
    <ImageSearchModal ref="cropModalRef" @confirm="onCropConfirmed" @cancel="onCropCancelled" />
  </div>
</template>
