...
<template>
  <div class="flex items-center gap-3 font-sans text-sm text-gray-600">
    <div
      class="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-sm"
    >
    ...
    <div
      class="flex items-center bg-white border border-gray-300 rounded-lg shadow-sm overflow-hidden"
    >
      <button
        @click="changePage(1)"
